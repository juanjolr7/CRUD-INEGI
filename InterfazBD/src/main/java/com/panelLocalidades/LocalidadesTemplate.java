 ...
 * @author juanj
 */
public class LocalidadesTemplate extends JPanel {

    //Servicios y objetos
    private LocalidadesComponent localidadesComponent;
    ...
    private JLabel lIdEntidad, lNombreLocalidad, lIdMunicipio, lIdLocalidad;
    private JTextField tNombre, tIdEntidad, tIdMunicipio, tIdlocalidad;
    ...
    public LocalidadesTemplate(LocalidadesComponent localidadesComponent) {
        this.localidadesComponent = localidadesComponent;
    ...
    public void crearContenidoPOpciones() {
        ...
        bLimpiar.addMouseListener(localidadesComponent);
        bLimpiar.addActionListener(localidadesComponent);
        ...
        bInsertar.addMouseListener(localidadesComponent);
        bInsertar.addActionListener(localidadesComponent);
        ...
        bModificar.addMouseListener(localidadesComponent);
        bModificar.addActionListener(localidadesComponent);
        ...
        bEliminar.addMouseListener(localidadesComponent);
        bEliminar.addActionListener(localidadesComponent);
    ...
    public void crearContenidoPDatos() {
        ...
        lInstrucciones = sObjGraficos.construirJLabel(
                "<html>Datos de las localidades<html>",
                20, 10, 120, 50,
                null, null,
        ...
        lEslogan = sObjGraficos.construirJLabel(
                "<html>A continuación puede ver y editar la información de la Localidad<html>",
                20, 50, 180, 90,
                null, null,
        ...
        tIdEntidad.addFocusListener(localidadesComponent);
        ...
        tIdMunicipio.addFocusListener(localidadesComponent);
        ...
        tIdlocalidad.addFocusListener(localidadesComponent);
        pDatos.add(tIdlocalidad);
        
        // LABEL NOMBRE LOCALIDAD----------------------------------------------------------------
        lNombreLocalidad = sObjGraficos.construirJLabel(
                "Nombre Municipio:",
                20, 350, 160, 30,
                null, null,
                sRecursos.getFontLigera(),
        ...
        tNombre.addFocusListener(localidadesComponent);
        pDatos.add(tNombre);
    }
    ...
    public void crearJTable() {
        ...
        tabla.addMouseListener(localidadesComponent);
